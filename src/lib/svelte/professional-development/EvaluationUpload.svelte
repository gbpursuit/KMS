<script lang="ts">
	...
	let { editable, currentContent = $bindable(), initialContent = $bindable() }: { editable: boolean, currentContent: EditableContent | null, initialContent: EditableContent | null } = $props();
...
{#if currentContent}
	<div class="flex flex-row w-full items-start">
		<UploadFile style="csv" bind:filePath={currentContent.content} editable={editable} />
