<script lang="ts">
    ...
    switch(style) {
        ...
        case 'modal-submit':
            ...
            break;
        case 'pdf':
            styleValue = 'bg-[var(--font-green)] text-white fixed z-10 bottom-5 right-5 w-13 h-13 p-1 rounded-full border border-[var(--font-green)] cursor-pointer hover:scale-102 hover:bg-[var(--hover-green)] transition duration-300 ease-in-out'
            break;
