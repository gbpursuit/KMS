<!-- <script lang="ts">
    ...
    let modules = [
        {id: 1, name: "Research", text: "24 Courses", icon: faAtom, allowed: true},
        {id: 2, name: "Curriculum Development", text: "38 Courses", icon: faClipboard, allowed: true},
        {id: 3, name: "Professional Development", text: "38 Courses", icon: faPersonChalkboard, allowed: true},
        {id: 4, name: "Extension", text: "38 Courses", icon: faPalette, allowed: true},
    ]
...
<div class="flex flex-col w-full h-[70dvh]">
    <div class="flex flex-col w-full h-full justify-center items-center px-10 pt-10 pb-5 ">
        ...
        <div class="grid grid-cols-2 grid-rows-2 lg:grid-cols-4 lg:grid-rows-1 w-full h-[70%] place-items-center">
                {#each modules as m}
                    <button class="flex flex-col w-[170px] h-[170px] sm:w-[180px] sm:h-[180px] md:w-[190px] md:h-[190px] lg:w-[200px] lg:h-[200px] xl:w-[250px] xl:h-[250px] rounded-3xl border border-black/20 
